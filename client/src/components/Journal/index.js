...
const JournalItem = (props) => {
  ...
  return (
    <div className="flex mt-5 mx-auto flex-column justify-content-center">
      <div className="pb-1">
        <button className="btn btn-primary btn-sm" onClick={prevPage}>
          Previous page
        </button>

        [<span>{currentPage}</span> of <span>37</span>]
